...
{
	float ned_rot_x = ((float)gps.ned_vel.x/100)*sin(gps.course/(1e7))+((float)gps.ned_vel.y/100)*sin( (gps.course/(1e7)) - M_PI/2);
	float ned_rot_y = ((float)gps.ned_vel.x/100)*cos(gps.course/(1e7))+((float)gps.ned_vel.y/100)*cos( (gps.course/(1e7)) - M_PI/2);
